...
How Kimi K3 maps onto this codebase. This is the K3 BACKEND, not the runtime it now runs
on -- see [ARCHITECTURE.md](ARCHITECTURE.md) for that. Section numbers below refer to K3's own technical
report, which is not redistributed here -- see
[the upstream repository](https://github.com/FareedKhan-dev/kimi-k3-in-c).
